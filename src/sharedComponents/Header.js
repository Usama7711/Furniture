...
const Header = () => {
  ...
  const handleScroll = () => {
    ...
    if (scrollY >= windowHeight && scrollY <= windowHeight * 2.1) {
      setService(true);
    } else {
      setService(false);
    }

    if (scrollY >= windowHeight * 2.1 && scrollY <= windowHeight * 3) {
      setResume(true);
    } else {
      setResume(false);
    }
        ...
        <header id='myHeader'>
          <nav>
            ...
            <div className={service ? "active" : ""}>
              <a href="#ServicesMe">Collections</a>
            </div>
            <div className={resume ? "active" : ""}>
              <a href="#ResumeMe">Showroom</a>
            </div>
        ...
        <Offcanvas show={show} onHide={handleClose}>
          ...
          <Offcanvas.Body>
            <div className="repsonsiveInerrList">
              ...
              <a  onClick={handleClose} href="#AboutMe">Collaction</a>
              <a  onClick={handleClose} href="#ServicesMe">Showroom</a>
              <a  onClick={handleClose} href="#ResumeMe">About</a>
            </div>
          </Offcanvas.Body>
        </Offcanvas>
